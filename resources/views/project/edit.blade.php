                ...
                <div class="flex items-center justify-between gap-4 pt-4 border-t border-gray-100">
                    <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-100">
                        ...
                        <button
                            ...
                            class="px-5 py-2 rounded-xl bg-red-600 border border-transparent text-sm font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2"
                        >
                            Delete Project
                        </button>
                    </div>
