...
//projects
Route::get('/projects', [\App\Http\Controllers\ProjectController::class, 'index'])->middleware('auth')->name('projects.index');
Route::get('/project/{id}', [\App\Http\Controllers\ProjectController::class, 'show'])->middleware('auth')->name('projects.show');
Route::get('/projects/create', [\App\Http\Controllers\ProjectController::class, 'create'])->middleware('auth')->name('projects.create');
...
//issues
Route::get('/issues', [\App\Http\Controllers\IssueController::class, 'index'])->middleware('auth')->name('issues.index');
Route::get('/issues/create', [\App\Http\Controllers\IssueController::class, 'create'])->middleware('auth')->name('issues.create');
...
//tags
Route::get('/tags', [\App\Http\Controllers\TagController::class, 'index'])->middleware('auth')->name('tags.index');
Route::get('/tags/create', [\App\Http\Controllers\TagController::class, 'create'])->middleware('auth')->name('tags.create');
